...
public class Currency extends AbstractModel implements Serializable {
    ...
    public Currency(Long id, String name, String wangwang, String qq,String qqName, Date birthday, String gender, String phone, boolean disabled, Date addTime, Date updateTime) {
        this.id = id;
        this.name = name;
