...
public class SystemInformation extends AbstractModel implements Serializable {
    ...
    public SystemInformation(Long id) {
        this.id = id;
    }

    public SystemInformation(Long id, String name, String wangwang, String qq,String qqName, Date birthday, String gender, String phone, boolean disabled, Date addTime, Date updateTime) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SystemInformation)) {
            return false;
        }
        SystemInformation other = (SystemInformation) object;
    ...
    public String toString() {
        return "me.ronghai.sa.model.SystemInformation[ id=" + id + " ]";
    }
    ...
    public static  SystemInformation fromJson(JSONObject json){               
        expectOne(json, "name");
        ...
        return SystemInformation.fromJson(json, SystemInformation.class);
    }
}
