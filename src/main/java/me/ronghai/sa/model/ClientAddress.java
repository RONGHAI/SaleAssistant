...
public class ClientAddress extends AbstractModel implements Serializable {
    ...
    public ClientAddress(Long id, String name, String wangwang, String qq,String qqName, Date birthday, String gender, String phone, boolean disabled, Date addTime, Date updateTime) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "me.ronghai.sa.model.ClientAddress[ id=" + id + " ]";
    }
