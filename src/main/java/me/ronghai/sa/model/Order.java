...
public class Order extends AbstractModel implements Serializable {
    ...
    public Order(Long id, String name, String wangwang, String qq,String qqName, Date birthday, String gender, String phone, boolean disabled, Date addTime, Date updateTime) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "me.ronghai.sa.model.Order[ id=" + id + " ]";
    }
