...
public class Hashtag extends AbstractModel implements Serializable {
    ...
    private static ModelMeta<Hashtag> modelMeta;
    @Override
    public   ModelMeta<Hashtag> modelMeta(){
        return _getModelMeta();
    }
    public static   ModelMeta<Hashtag> _getModelMeta(){
        if(modelMeta == null){
            modelMeta = new ModelMeta<>(Hashtag.class);
        }
        return modelMeta;
    }
}
